...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build a guarded quantization-focused zh-en training set.")
    ...
    parser.add_argument("--prefix", default="quant-guard")
...
def main() -> None:
    ...
    quant_samples, quant_stats = build_quant_focus_samples(
        term_entries,
        alias_entries,
        term_repeat=args.term_repeat,
        alias_repeat=args.alias_repeat,
    )
    chat_samples, chat_stats = build_chat_guard_samples(repeat=args.chat_repeat)
    samples = quant_samples + chat_samples
